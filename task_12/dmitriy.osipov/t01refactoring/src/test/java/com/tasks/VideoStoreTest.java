...
public class VideoStoreTest extends TestCase {
  ...
  public void testSingleNewReleaseStatement() {
    customer.addRental(new Rental(new Movie("The Cell", MoviePriceCode.NEW_RELEASE), 3));
    assertEquals(
  ...
  public void testDualNewReleaseStatement() {
    customer.addRental(new Rental(new Movie("The Cell", MoviePriceCode.NEW_RELEASE), 3));
    customer.addRental(new Rental(new Movie("The Tigger Movie", MoviePriceCode.NEW_RELEASE), 3));
    assertEquals(
